...
\input{Kapitel/Einstellungen}
\input{Kapitel/Packages}
...
\input{Kapitel/formelzeichen.tex}
\newpage
\thispagestyle{empty}
\cleardoublepage 
...
%/Einleitung
\input{Kapitel/Einleitung}	% einfügen von inhalt/inhalt.tex
\newpage
\thispagestyle{empty} 
\cleardoublepage
...
\begin{appendices}
\input{Kapitel/anhang.tex}	% Einbinden des Anhangs
\end{appendices}
\newpage
\thispagestyle{empty}
\cleardoublepage
